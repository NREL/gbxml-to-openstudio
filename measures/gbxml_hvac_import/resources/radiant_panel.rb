class RadiantPanel < HVACObject
  attr_accessor :radiant_panel, :supply_fan, :cooling_coil, :cooling_loop_ref, :heating_coil, :heating_coil_type, :heating_loop_ref
  ...
  def connect_thermal_zone(thermal_zone)
    self.radiant_panel.addToThermalZone(thermal_zone)
  end
