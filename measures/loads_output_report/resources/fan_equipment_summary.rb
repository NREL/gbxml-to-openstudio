...
class FanEquipmentSummary < JSONable
  attr_accessor :type, :total_efficiency, :delta_pressure, :max_air_flow_rate, :rated_power_per_max_air_flow_rate,
                :motor_heat_in_air_fraction, :end_use, :design_day_name_for_fan_sizing_peak, :date_time_for_fan_sizing_peak
