  ...
  module Mappers
    class EngineeringCheckMapper
      def call(peak_load_component_table, peak_condition, engineering_check)
        ...
        result.airflow_per_floor_area = peak_condition.main_fan_air_flow / floor_area
        result.airflow_per_total_capacity = peak_condition.main_fan_air_flow / total_capacity
        result.floor_area_per_total_capacity = floor_area / total_capacity
        result.total_capacity_per_floor_area = total_capacity / floor_area
