...
class TestOutputService < MiniTest::Test
  attr_accessor :model, :output_service
  ...
  def before_setup
    ...
    self.model = OpenStudio::Model::Model.load(OpenStudio::Path.new(Config::RESOURCES + '/peak_load_component_repository.osm')).get
  end
