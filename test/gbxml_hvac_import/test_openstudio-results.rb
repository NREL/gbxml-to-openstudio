...
class TestOSResult < MiniTest::Test
  ...
  def before_setup
    self.gbxml_path = Config::GBXML_FILES + '/SIReportUnits.xml'
  ...
  def create_osw
    ...
    osw = adjust_gbxml_paths(osw, 'SIReportUnits.xml')
    osw_in_path = Config::TEST_OUTPUT_PATH + '/sireport_fix/in.osw'
  ...
  def test_simulation
    ...
    osw_out_path = Config::TEST_OUTPUT_PATH + '/sireport_fix/out.osw'
