...
class TestACB < MiniTest::Test
  ...
  def before_setup
    self.gbxml_path = Config::GBXML_FILES + '/ACBAllVariations.xml'
  ...
  def test_create_osw
    ...
    osw = add_gbxml_test_measure_steps(osw, 'ACBAllVariations.xml')
    osw_in_path = Config::TEST_OUTPUT_PATH + '/acb/in.osw'
  ...
  def test_simulation
    ...
    osw_out_path = Config::TEST_OUTPUT_PATH + '/acb/out.osw'
