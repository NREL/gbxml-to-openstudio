...
class TestWSHP < MiniTest::Test
  ...
  def before_setup
    self.gbxml_path = Config::GBXML_FILES + '/WSHPAllVariations.xml'
  ...
  def create_osw
    ...
    osw = adjust_gbxml_paths(osw, 'WSHPAllVariations.xml')
    osw_in_path = Config::TEST_OUTPUT_PATH + '/wshp/in.osw'
  ...
  def test_simulation
    ...
    osw_out_path = Config::TEST_OUTPUT_PATH + '/wshp/out.osw'
