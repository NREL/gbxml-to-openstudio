...
class TestBaseboardConvective < MiniTest::Test
  ...
  def before_setup
    self.gbxml_path = Config::GBXML_FILES + '/BaseboardConvectiveAllVariations.xml'
  ...
  def test_create_osw
    ...
    osw = add_gbxml_test_measure_steps(osw, 'BaseboardConvectiveAllVariations.xml')
    osw_in_path = Config::TEST_OUTPUT_PATH + '/baseboard_convective/in.osw'
  ...
  def test_simulation
    ...
    osw_out_path = Config::TEST_OUTPUT_PATH + '/baseboard_convective/out.osw'
