...
class TestFPFC < MiniTest::Test
  ...
  def before_setup
    self.gbxml_path = Config::GBXML_FILES + '/FPFCAllVariations.xml'
  ...
  def create_osw
    ...
    osw = adjust_gbxml_paths(osw, 'FPFCAllVariations.xml')
    osw_in_path = Config::TEST_OUTPUT_PATH + '/fpfc/in.osw'
  ...
  def test_simulation
    ...
    osw_out_path = Config::TEST_OUTPUT_PATH + '/fpfc/out.osw'
