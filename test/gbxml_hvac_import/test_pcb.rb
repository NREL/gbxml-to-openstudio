...
class TestPCB < MiniTest::Test
  ...
  def before_setup
    self.gbxml_path = Config::GBXML_FILES + '/PCBAllVariations.xml'
  ...
  def create_osw
    ...
    osw = adjust_gbxml_paths(osw, 'PCBAllVariations.xml')
    osw_in_path = Config::TEST_OUTPUT_PATH + '/pcb/in.osw'
  ...
  def test_simulation
    ...
    osw_out_path = Config::TEST_OUTPUT_PATH + '/pcb/out.osw'
