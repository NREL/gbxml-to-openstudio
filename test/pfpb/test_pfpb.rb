...
class TestPFPB < MiniTest::Test
  ...
  def before_setup
    self.gbxml_path = TestConfig::GBXML_FILES + '/PFPBAllVariations.xml'
  ...
  def test_create_osw
    ...
    osw = TestConfig.add_gbxml_test_measure_steps(osw, 'PFPBAllVariations.xml')
    osw_in_path = TestConfig::TEST_OUTPUT_PATH + '/pfpb/in.osw'
  ...
  def test_simulation
    ...
    osw_out_path = TestConfig::TEST_OUTPUT_PATH + '/pfpb/out.osw'
